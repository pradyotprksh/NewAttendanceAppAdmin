        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(subject) && !from.equals("From") && !to.equals("To")) {
                    ...
                    adminAddTimetableFirestore.collection("Timetable").document(classValue).collection("Thursday").document().set(adminMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override

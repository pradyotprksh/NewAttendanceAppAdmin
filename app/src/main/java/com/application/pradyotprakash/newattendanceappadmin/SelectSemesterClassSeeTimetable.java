...
public class SelectSemesterClassSeeTimetable extends AppCompatActivity {

    private android.support.v7.widget.Toolbar mToolbar;
    private RecyclerView mClassListView;
    private List<TimetableClasses> classesList;
    private SeeTimetableClassRecyclerAdapter classRecyclerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_semester_class_see_timetable);
        ...
        ArrayAdapter<String> adapterSemester = new ArrayAdapter<>(SelectSemesterClassSeeTimetable.this, android.R.layout.simple_dropdown_item_1line, semester);
        ...
        mClassListView = findViewById(R.id.admin_class_list);
        classesList = new ArrayList<>();
        classRecyclerAdapter = new SeeTimetableClassRecyclerAdapter(classesList, getApplicationContext());
        ...
        getClass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(semester)) {
                    adminGetClassFirestore.collection("Class").document(branch).collection(semester).orderBy("classValue").addSnapshotListener(SelectSemesterClassSeeTimetable.this, new EventListener<QuerySnapshot>() {
                        @Override
                    ...
                    Toast.makeText(SelectSemesterClassSeeTimetable.this, "Select Semester", Toast.LENGTH_LONG).show();
                }
            }
        });
    }

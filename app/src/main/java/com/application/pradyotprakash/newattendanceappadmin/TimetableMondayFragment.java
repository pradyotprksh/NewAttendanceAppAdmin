...
public class TimetableMondayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_timetable_monday, container, false);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(subject) && !from.equals("From") && !to.equals("To")) {
                    ...
                    adminAddTimetableFirestore.collection("Timetable").document(classValue).collection("Monday").document().set(adminMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override

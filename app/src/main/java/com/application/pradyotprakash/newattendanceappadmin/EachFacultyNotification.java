...
public class EachFacultyNotification extends AppCompatActivity {

    private TextView label;
    private EditText message;
    private Button sendBtn;
    private String facultyId, name, user_id, senderName, senderImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_each_faculty_notification);
        ...
        adminMainFirestore.collection("Admin").document(user_id).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(EachFacultyNotification.this, "Error: " + retrieving_error, Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(value)) {
                    ...
                    mFirestore.collection("Faculty/" + facultyId + "/Notifications").add(notificationMessage).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                        @Override
                        public void onSuccess(DocumentReference documentReference) {
                            Toast.makeText(EachFacultyNotification.this, "Notification Sent.", Toast.LENGTH_SHORT).show();
                            message.setText("");
                            mProgressbar.setVisibility(View.INVISIBLE);
                        }
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(EachFacultyNotification.this, "Error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                            mProgressbar.setVisibility(View.INVISIBLE);
                        }
                    });
                } else {
                    Toast.makeText(EachFacultyNotification.this, "Write A Message.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }

...
public class TuesdaySubjectRecyclerAdapter extends RecyclerView.Adapter<TuesdaySubjectRecyclerAdapter.ViewHolder> {
    ...
    private String classValue = TimetableTuesdayFragment.getClassValue();
    ...
    @Override
    public TuesdaySubjectRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.monday_subject_list, parent, false);
        return new TuesdaySubjectRecyclerAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final TuesdaySubjectRecyclerAdapter.ViewHolder holder, final int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("dayValue", "Tuesday");
